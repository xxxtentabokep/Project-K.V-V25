-- [[ KRYPTON VERSE.hub - OFFICIAL PROJECT-KV-VII FINAL PATCH (INTEGRATED BY KRYPTON) ]] --
...
-- Fixed: 360 Degree Smooth Admin Fly & Min Fly Speed set to 16
-- INTEGRATED: VIP BodyHighlight ESP (Chams Mode Always On Top)
-- THEME: BLACK SOLID + WHITE TEXT (NO TRANSPARENCY)
-- ADDED: Aimlock Torso & Aimlock Head (NEW FEATURES)
-- FIXED: Aimbot now respects FOV Circle (only locks enemies inside FOV)
...
-- ============================================= --
-- 🛠️ KRYPTON FINAL CONFIG — SAFELINKU --------- --
-- ============================================= --
local LootlabsLink = "https://sfl.gl/GbuUA"

-- ============================================= --
-- 🔑 KEY VERIFIKASI STATIS (HARDCODE) --------- --
-- ============================================= --
local RealKey = "KRYPTON_VERSE_HUB_DAILY_KEY_{date}"
...
-- ============================================= --
-- 🔐 KEY SYSTEM GUI (HITAM SOLID + PUTIH) ----- --
-- ============================================= --
...
Frame.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Hitam solid
Frame.Active = true
...
Desc.Size = UDim2.new(0.92, 0, 0.32, 0) 
Desc.Position = UDim2.new(0.04, 0, 0.22, 0)
Desc.Text = "Daily key link has been auto-copied! Paste it into your browser. Look for the 'OPEN' button, and keep pressing it until the tab changes to 'OPEN LINK' to get your key.\n\nExpected Key Format: KRYPTON_VERSE_HUB_DAILY_KEY_29_05_2026"
Desc.TextColor3 = Color3.fromRGB(255, 255, 255) -- Putih
...
TextBox.Size = UDim2.new(0.85, 0, 0.18, 0)
TextBox.Position = UDim2.new(0.075, 0, 0.56, 0) 
TextBox.BackgroundColor3 = Color3.fromRGB(40, 40, 40) -- Abu gelap solid
TextBox.Text = ""
TextBox.PlaceholderText = "Tempel Teks Key Di Sini..."
...
SubmitBtn.BackgroundColor3 = Color3.fromRGB(60, 60, 60) -- Abu solid
SubmitBtn.Text = "CHECK KEY"
SubmitBtn.TextColor3 = Color3.fromRGB(255, 255, 255) -- Putih
...
GetLinkBtn.Size = UDim2.new(0.4, 0, 0.18, 0)
GetLinkBtn.Position = UDim2.new(0.525, 0, 0.74, 0) 
GetLinkBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 30) -- Hitam solid
GetLinkBtn.Text = "COPY LINK AGAIN"
GetLinkBtn.TextColor3 = Color3.fromRGB(255, 255, 255) -- Putih
...
SubmitBtn.MouseButton1Click:Connect(function()
    local userKey = TextBox.Text:gsub("%s+", ""):gsub("%c+", "")
    ...
    if userKey == RealKey and RealKey ~= "" then
        ...
        -- ======================================================= --
        -- LOAD SCRIPT UTAMA KRYPTON VERSE HUB --
        -- ======================================================= --
        
        local _G = { 
            AimbotMaster = false, AimlockTorso = false, AimlockHead = false, AimbotCursor = false, AimbotChar = false,
        ...
        MainFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Hitam solid
        ...
        Sidebar.BackgroundColor3 = Color3.fromRGB(15, 15, 15) -- Lebih gelap dikit
        ...
        Logo.Text = "KRYPTON\nVERSE.hub"
        Logo.TextColor3 = Color3.fromRGB(255, 255, 255) -- Putih
        ...
        MainPage.CanvasSize = UDim2.new(0, 0, 0, 570)
        ...
        BoostPage.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 100)
        ...
        SecurityPage.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 100)
        ...
        -- FITUR BARU: AIMLOCK TORSO & HEAD
        CreateToggle(MainPage, "→ Aimlock Torso", 24, "AimlockTorso", function(s)
            if s then
                _G.AimlockHead = false
                local f = MainPage:FindFirstChild("→ Aimlock Head")
        ...
        CreateToggle(MainPage, "→ Aimlock Head", 48, "AimlockHead", function(s)
            if s then
                _G.AimlockTorso = false
                local f = MainPage:FindFirstChild("→ Aimlock Torso")
                local btn = f and f:FindFirstChildWhichIsA("TextButton")
                if btn then
                    btn.Text = "OFF"
                    btn.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
        ...
        local tglCursor = CreateToggle(MainPage, "→ Aimbot (Closest to Cursor)", 72, "AimbotCursor", function(s)
            if s then 
                _G.AimbotChar = false
        ...
        local tglChar = CreateToggle(MainPage, "→ Aimbot (Closest to Character)", 96, "AimbotChar", function(s)
            if s then 
        ...
        CreateToggle(MainPage, "Full Visual Master ESP", 124, "ESP")

        local tglTeam = CreateToggle(MainPage, "→ ESP Mode: TEAM ONLY", 148, "ESPModeTeam", function(s)
            if s then 
                _G.ESPMode = "TEAM"
        ...
        local tglFFA = CreateToggle(MainPage, "→ ESP Mode: FFA (Free For All)", 172, "ESPModeFFA", function(s)
            if s then 
                _G.ESPMode = "FFA"
        ...
        CreateToggle(MainPage, "🎯 Show FOV Circle", 200, "ShowFOVCircle")
        CreateToggle(MainPage, "Hitbox Expander (Universal)", 224, "HitboxExpand")
        CreateSlider(MainPage, "Hitbox Size", 248, 2, 50, "HitboxSize")
        CreateToggle(MainPage, "Real Admin Fly", 284, "Fly")
        CreateToggle(MainPage, "No Clip Matrix", 308, "NoClip")
        CreateSlider(MainPage, "Fly Speed Multiplier", 332, 16, 1000, "FlySpeed")
        CreateSlider(MainPage, "Aim FOV Range Radius", 368, 50, 800, "AimFOV")
        CreateToggle(MainPage, "Bypass Super Speed", 404, "SuperSpeed")
        CreateSlider(MainPage, "Speed Velocity Engine", 428, 16, 1000, "RunSpeed")
        CreateToggle(MainPage, "Ambient Brightness Mod", 464, "BrightnessToggle", function(s)
            if not s then 
        ...
        -- ============ TELEPORT FRAME ================= --
        -- ============================================= --
        local TpFrame = Instance.new("Frame", MainPage)
        TpFrame.Size = UDim2.new(1, -8, 0, 32)
        TpFrame.Position = UDim2.new(0, 0, 0, 493)
        ...
        NameBox.Size = UDim2.new(0.6, -5, 1, -8)
        NameBox.Position = UDim2.new(0, 5, 0, 4)
        ...
        NameBox:GetPropertyChangedSignal("Text"):Connect(function()
            _G.TeleportTarget = NameBox.Text
        end)
        
        local TpBtn = Instance.new("TextButton", TpFrame)
        TpBtn.Size = UDim2.new(0.4, -5, 1, -8)
        TpBtn.Position = UDim2.new(0.6, 2, 0, 4)
        ...
        TpBtn.MouseButton1Click:Connect(function()
            if _G.TeleportTarget ~= "" then
                local targetLower = string.lower(_G.TeleportTarget)
                local myChar = LocalPlayer.Character
                local myHrp = myChar and myChar:FindFirstChild("HumanoidRootPart")
                if myHrp then
                    for _, p in pairs(Players:GetPlayers()) do
                        if p ~= LocalPlayer and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
                            if string.sub(string.lower(p.Name), 1, #targetLower) == targetLower or 
                               string.sub(string.lower(p.DisplayName), 1, #targetLower) == targetLower then
                ...
                if p ~= LocalPlayer then
                    ...
                    if pChar and pChar:FindFirstChild("Head") and pChar:FindFirstChild("HumanoidRootPart") then
                        ...
                        if onScreen and _G.AimbotMaster and isEnemy then
                            ...
                            -- Hitung jarak dari cursor ke target (untuk pengecekan FOV)
                            local distCursor = (Vector2.new(pos.X, pos.Y) - cursorPosition).Magnitude
                            
                            -- Cek apakah target masih dalam jangkauan FOV
                            if distCursor <= _G.AimFOV then
                                -- Prioritas: Aimlock Head > Aimlock Torso > Aimlock Cursor/Char
                                if _G.AimlockHead then
                                    targetPart = head
                                elseif _G.AimlockTorso then
                                    targetPart = tHrp
                                elseif _G.AimbotCursor then
